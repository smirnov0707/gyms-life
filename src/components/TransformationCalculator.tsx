  ...
  return (
    <div className="my-10 p-6 md:p-8 rounded-3xl border border-border bg-gradient-to-b from-surface to-surface shadow-2xl backdrop-blur-xl">
      <div className="text-center max-w-xl mx-auto mb-8">
        ...
        <p className="text-xs md:text-sm text-muted-foreground mt-1">{t("tl.tc.subtitle")}</p>
      </div>
        ...
        <div className="space-y-6">
          <div>
            <div className="flex justify-between text-xs font-mono text-foreground mb-2">
              ...
              <strong className="text-indigo-400 text-sm">
                {t("tl.tc.durationWeeks").replace("{n}", String(weeks))}
              </strong>
            </div>
            <Slider
              min={4}
          ...
          <div>
            <div className="flex justify-between text-xs font-mono text-foreground mb-2">
              ...
              <strong className="text-indigo-400 text-sm">
                {t("tl.tc.frequencyPerWeek").replace("{n}", String(daysPerWeek))}
              </strong>
            </div>
            <Slider
              min={2}
        ...
        <div className="grid grid-cols-2 gap-3 text-center">
          ...
          <div className="p-4 rounded-2xl bg-surface border border-border shadow-md">
            ...
            <div className="text-2xl font-black text-accent mt-1">
              {(estimatedKcalBurned / 1000).toFixed(1)}k
            </div>
