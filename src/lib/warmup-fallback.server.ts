...
const NAMES: Record<string, Record<string, string>> = {
  "cat-cow": { lt: "Katė–karvė", en: "Cat–cow", ru: "Кошка–корова", uk: "Кішка–корова", pl: "Kot–krowa", de: "Katze–Kuh", es: "Gato–vaca", fr: "Chat–vache" },
  "thoracic-rotation": { lt: "Krūtinės rotacija", en: "Thoracic rotation", ru: "Ротация грудного отдела", uk: "Ротація грудного відділу", pl: "Rotacja piersiowa", de: "Brustwirbel-Rotation", es: "Rotación torácica", fr: "Rotation thoracique" },
  "band-pull-apart": { lt: "Gumos atitraukimas", en: "Band pull-apart", ru: "Разведение резины", uk: "Розведення гумки", pl: "Rozciąganie gumy", de: "Band Pull-apart", es: "Apertura con banda", fr: "Écarté à l'élastique" },
  "bird-dog": { lt: "Paukštis–šuo", en: "Bird dog", ru: "Птица-собака", uk: "Птах-собака", pl: "Bird dog", de: "Bird Dog", es: "Bird dog", fr: "Bird dog" },
  "glute-bridge": { lt: "Sėdmenų tiltelis", en: "Glute bridge", ru: "Ягодичный мостик", uk: "Сідничний місток", pl: "Mostek biodrowy", de: "Glute Bridge", es: "Puente de glúteo", fr: "Pont fessier" },
  "bodyweight-squat": { lt: "Pritūpimai be svorio", en: "Bodyweight squat", ru: "Приседания без веса", uk: "Присідання без ваги", pl: "Przysiad bez obciążenia", de: "Kniebeuge ohne Gewicht", es: "Sentadilla sin peso", fr: "Squat au poids du corps" },
  "reverse-lunge": { lt: "Atbuli išpuoliai", en: "Reverse lunge", ru: "Обратные выпады", uk: "Зворотні випади", pl: "Wykrok w tył", de: "Ausfallschritt rückwärts", es: "Zancada atrás", fr: "Fente arrière" },
  "band-lateral-walk": { lt: "Šoniniai žingsniai su guma", en: "Band lateral walk", ru: "Боковые шаги с резиной", uk: "Бічні кроки з гумкою", pl: "Kroki bokiem z gumą", de: "Seitwärtsgehen mit Band", es: "Pasos laterales con banda", fr: "Pas latéraux élastique" },
  "jumping-jack": { lt: "Šuoliai su rankų mojais", en: "Jumping jacks", ru: "Прыжки «звёздочка»", uk: "Стрибки «зірочка»", pl: "Pajacyki", de: "Hampelmänner", es: "Saltos de tijera", fr: "Jumping jacks" },
  "plank": { lt: "Lenta", en: "Plank", ru: "Планка", uk: "Планка", pl: "Deska", de: "Plank", es: "Plancha", fr: "Planche" },
};
