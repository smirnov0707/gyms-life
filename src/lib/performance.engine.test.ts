...
describe("performance engine", () => {
  ...
  it("does not calculate volume from missing weight", () => expect(calculateVolume(10, null)).toBe(0));
  it("calculates estimated 1RM separately from actual weight", () => expect(calculateEstimated1RM(100, 10)).toBe(133.3));
