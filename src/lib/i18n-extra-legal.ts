export const extra_legal = {
  "lg.nav.pricing": { lt: "Kainos", en: "Pricing" },
  ...
  "lg.terms.p3": {
    lt: "Privalote saugoti prisijungimo duomenis ir atsakote už veiklą savo paskyroje. Teikta informacija turi būti tiksli.",
    en: "You must keep your login credentials safe and are responsible for activity on your account. The information you provide must be accurate.",
  },
  "lg.terms.h4": { lt: "4. Mokėjimai ir prenumerata", en: "4. Payments and Subscription" },
  "lg.terms.p4a": {
    lt: "Užsakymo procesą vykdo mūsų internetinis perpardavinėtojas Paddle.com. Paddle.com yra visų mūsų užsakymų įgaliotasis pardavėjas (Merchant of Record). Paddle teikia visą klientų aptarnavimą mokėjimų klausimais ir tvarko grąžinimus. Mokėjimo, atsiskaitymo, mokesčių, atšaukimo ir grąžinimo mechanika reglamentuojama",
    en: "The order process is handled by our online reseller Paddle.com. Paddle.com is the Merchant of Record for all our orders. Paddle provides all customer service for payment-related inquiries and handles refunds. Payment, billing, tax, cancellation and refund mechanics are governed by",
  },
  "lg.terms.p4link": { lt: "Paddle pirkėjo sąlygomis", en: "Paddle's buyer terms" },
  "lg.terms.p4b": {
    lt: "Prenumerata atsinaujina automatiškai pasirinktu laikotarpiu (savaitė / mėnuo / metai), kol jos neatšauksite. Atšaukti galite bet kada – prieiga išlieka iki apmokėto laikotarpio pabaigos.",
    en: "The subscription renews automatically for the chosen period (week / month / year) until you cancel it. You may cancel at any time – access remains until the end of the paid period.",
  },
  "lg.terms.h5": { lt: "5. Draudžiama veikla", en: "5. Prohibited Activities" },
  "lg.terms.p5": {
    lt: "Draudžiama paslaugą naudoti neteisėtai, platinti šiukšles, pažeidinėti intelektinę nuosavybę, bandyti pažeisti saugumą (kenkėjiška programinė įranga, sistemų tyrinėjimas, duomenų griebimas), kopijuoti ar perparduoti paslaugos turinį.",
    en: "It is prohibited to use the service unlawfully, distribute spam, infringe intellectual property, attempt to breach security (malware, system probing, data scraping), or copy or resell the service's content.",
  },
  "lg.terms.h6": { lt: "6. Intelektinė nuosavybė", en: "6. Intellectual Property" },
  "lg.terms.p6": {
    lt: "Paslauga, programinė įranga, dokumentacija ir prekės ženklai yra pardavėjo nuosavybė. Suteikiame ribotą, neišskirtinę, neperduodamą teisę naudotis paslauga pagal pasirinktą planą.",
    en: "The service, software, documentation and trademarks are the property of the seller. We grant a limited, non-exclusive, non-transferable right to use the service under the chosen plan.",
  },
  "lg.terms.h7": { lt: "7. Atsakomybės apribojimas", en: "7. Limitation of Liability" },
  "lg.terms.p7": {
    lt: "Tiektame įstatymų leidžiama apimtimi neatsakome už netiesioginius nuostolius; bendra atsakomybė ribojama per pastaruosius 12 mėnesių sumokėta suma. Tai netaikoma sukčiavimui ar žalai gyvybei ir sveikatai.",
    en: "To the extent permitted by law, we are not liable for indirect losses; total liability is limited to the amount paid in the last 12 months. This does not apply to fraud or harm to life and health.",
  },
  "lg.terms.h8": { lt: "8. Prieigos sustabdymas", en: "8. Suspension of Access" },
  "lg.terms.p8": {
    lt: "Galime sustabdyti arba nutraukti prieigą esant esminiam sąlygų pažeidimui, neapmokėjimui, saugumo ar sukčiavimo rizikai.",
    en: "We may suspend or terminate access in the event of a material breach of these terms, non-payment, or security or fraud risk.",
  },
  "lg.terms.h9": { lt: "9. Kontaktai", en: "9. Contact" },
  "lg.terms.p9": {
    lt: "Klausimais dėl sąlygų kreipkitės: Aleksandr Smirnov, per programėlės pagalbos kanalus.",
    en: "For questions about these terms, contact: Aleksandr Smirnov, via the app's support channels.",
  },
  ...
  "lg.privacy.p5": {
    ...
    en: "We retain data for as long as necessary to provide the service and as required by law; data that is no longer needed is deleted or anonymized.",
  },
  "lg.privacy.h6": { lt: "6. Jūsų teisės (ES/BDAR)", en: "6. Your Rights (EU/GDPR)" },
  "lg.privacy.p6": {
    lt: "Turite teisę susipažinti su duomenimis, juos taisyti, ištrinti, apriboti tvarkymą, perkelti, prieštarauti, atšaukti sutikimą ir pateikti skundą priežiūros institucijai. Į užklausas atsakome per 1 mėnesį.",
    en: "You have the right to access, rectify, erase, restrict processing, port your data, object, withdraw consent, and lodge a complaint with a supervisory authority. We respond to requests within 1 month.",
  },
  "lg.privacy.h7": { lt: "7. Tarptautiniai perdavimai", en: "7. International Transfers" },
  "lg.privacy.p7": {
    lt: "Jei duomenys perduodami už EEE ribų, taikome atitinkamas apsaugos priemones (standartines sutarčių sąlygas ar adekvatumo sprendimus).",
    en: "If data is transferred outside the EEA, we apply appropriate safeguards (standard contractual clauses or adequacy decisions).",
  },
  "lg.privacy.h8": { lt: "8. Saugumas", en: "8. Security" },
  "lg.privacy.p8": {
    lt: "Taikome tinkamas technines ir organizacines priemones: šifravimą, prieigos kontrolę, stebėseną.",
    en: "We apply appropriate technical and organizational measures: encryption, access control, monitoring.",
  },
  ...
  "lg.refund.p1": {
    ...
    en: "We offer a 30-day money-back guarantee. If it's not for you, we'll refund the full amount within 30 days of the order date, with no extra conditions.",
  },
  "lg.refund.h2": { lt: "Kaip pateikti prašymą", en: "How to Request a Refund" },
  "lg.refund.p2a": {
  ...
  "lg.pricing.plan.weekly.name": { lt: "Savaitinis", en: "Weekly" },
  "lg.pricing.plan.weekly.per": { lt: "/ savaitę", en: "/ week" },
  "lg.pricing.plan.weekly.tagline": { lt: "Lankstus startas", en: "Flexible start" },
  "lg.pricing.plan.monthly.name": { lt: "Mėnesinis", en: "Monthly" },
  "lg.pricing.plan.monthly.per": { lt: "/ mėnesį", en: "/ month" },
