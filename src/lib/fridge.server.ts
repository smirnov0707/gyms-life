...
const FOOD_TABLE: { match: string[]; kcal: number; p: number; c: number; f: number }[] = [
  { match: ["viščiuk", "vištien", "chicken", "kurica", "kurczak", "hähn", "pollo", "poulet"], kcal: 165, p: 31, c: 0, f: 3.6 },
  ...
  { match: ["kiaušin", "egg", "jajk", "яйц", "ei", "huevo", "oeuf"], kcal: 143, p: 13, c: 1, f: 10 },
  ...
  { match: ["pupel", "bean", "fasol", "lentil", "lęś", "lęšiai", "čočk"], kcal: 330, p: 22, c: 55, f: 1.5 },
  ...
  { match: ["riešut", "nut", "orzech", "орех", "almond", "migdol"], kcal: 600, p: 20, c: 20, f: 50 },
...
const T: Record<string, { title: string; steps: (list: string) => string[]; note: string; missing: string; time: string }> = {
  lt: {
    ...
    missing: "Pridėk žalumynų ir riebalų šaltinio (alyvuogių aliejaus arba riešutų) subalansavimui.",
    time: "20 min",
  },
  en: {
