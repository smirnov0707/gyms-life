...
describe("buildCoachContext", () => {
  it("builds a provider-neutral validated context", () => {
    const context = buildCoachContext({
      ...
      goal: "strength",
      activePlan: { id: "00000000-0000-4000-8000-000000000002", title: "Strength", dayIndex: 1 },
      performance: { workouts: 3, totalVolume: 1200, totalSets: 18, totalReps: 90, averageRpe: 7.8, exercises: [] },
      insights: [],
    });
