      ...
      <div className="mt-7 grid gap-4">
        {sessions.length === 0 ? (
          ...
          sessions.map((session) => {
            ...
            return (
              <GlowCard key={session.session.id} className="panel p-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  <div>
                    ...
                    <h2 className="mt-2 text-2xl">{session.session.title}</h2>
                  ...
                  {exercises.map((set) => (
                    <div key={set.exerciseSlug} className="rounded-lg bg-surface-2 px-4 py-3">
                      ...
                      <div className="mt-1 text-xs text-muted-foreground">
                        ...
                        atlikti setai · paskutinis: {set.reps ?? 0} reps × {set.weightKg ?? 0} kg
