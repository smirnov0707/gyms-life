...
export const Route = createFileRoute("/_authenticated/progress")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Savaitės tūris, kūno svorio kreivė ir asmeniniai rekordai." },
      { property: "og:title", content: "Progresas — GYMS.LIFE" },
      { property: "og:description", content: "Sek savo treniruočių tūrį, svorį ir asmeninius rekordus." },
    ],
  }),
