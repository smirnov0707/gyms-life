...
try {
  ...
  browser = await chromium.launch({
    ...
    // Without it these nine checks only ever run in CI, which is a poor place
    // to discover you have broken them.
    ...(process.env.TWIN_BROWSER_EXECUTABLE
      ? { executablePath: process.env.TWIN_BROWSER_EXECUTABLE }
      : {}),
