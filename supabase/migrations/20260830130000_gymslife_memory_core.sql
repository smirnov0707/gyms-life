-- GYMS.LIFE V6 — Memory Core
-- Long-term user memory. Conversation history remains in coach_messages.
...
DROP POLICY IF EXISTS "Users read own memory"
...
DROP POLICY IF EXISTS "Users delete own memory"
  ON public.user_memory;
