...
- **Resolved in this audit:** the 508 kB optional-locales bundle is split by language. A member downloads only their selected supplemental locale rather than all six packs.
